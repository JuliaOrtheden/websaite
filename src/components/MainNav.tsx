              ...
              <div className="col-span-2 grid grid-cols-2 gap-6">
                <a href="#" className="group block space-y-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">200% productivity increase</p>
                  </div>
                </a>
                <a href="#" className="group block space-y-2">
                  <div className="aspect-video overflow-hidden rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">50% cost reduction</p>
                  </div>
                </a>
              </div>
            </div>
            ...
            <div className="grid gap-4 p-6 w-[400px]">
              <div className="grid grid-cols-1 gap-4">
                <a href="#" className="block group">
                  ...
                  <p className="text-sm text-gray-500">Learn about our journey and mission</p>
                </a>
                <a href="#" className="block group">
                  <h3 className="text-lg font-semibold">Team</h3>
                  <p className="text-sm text-gray-500">Meet the people behind our success</p>
                </a>
                <a href="#" className="block group">
            ...
            <div className="grid gap-4 p-6 w-[400px]">
              <div className="grid grid-cols-1 gap-4">
                ...
                <a href="#" className="block group">
                  ...
                  <p className="text-sm text-gray-500">For growing companies</p>
                </a>
                <a href="#" className="block group">
                  <h3 className="text-lg font-semibold">Startup</h3>
                  <p className="text-sm text-gray-500">For new businesses</p>
                </a>
              </div>
            </div>
          </NavigationMenuContent>
            ...
            <div className="grid gap-4 p-6 w-[400px]">
              <div className="grid grid-cols-1 gap-4">
                <a href="#" className="block group">
                  ...
                  <p className="text-sm text-gray-500">Join our partner network</p>
                </a>
                <a href="#" className="block group">
                  <h3 className="text-lg font-semibold">Find a Partner</h3>
                  <p className="text-sm text-gray-500">Locate certified partners</p>
                </a>
              </div>
            </div>
          </NavigationMenuContent>
